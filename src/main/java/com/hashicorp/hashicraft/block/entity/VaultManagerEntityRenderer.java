...
public class VaultManagerEntityRenderer<T extends VaultManagerEntity> implements BlockEntityRenderer<T> {
  ...
  public VaultManagerEntityRenderer(BlockEntityRendererFactory.Context ctx) {
  }

  @Override
  public void render(VaultManagerEntity entity, float tickDelta, MatrixStack matrices,
