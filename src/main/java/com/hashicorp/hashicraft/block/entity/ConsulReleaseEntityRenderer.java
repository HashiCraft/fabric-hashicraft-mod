...
public class ConsulReleaseEntityRenderer<T extends ConsulReleaseEntity> implements BlockEntityRenderer<T> {
  public ConsulReleaseEntityRenderer(BlockEntityRendererFactory.Context ctx) {
  }

  @Override
  public void render(ConsulReleaseEntity entity, float tickDelta, MatrixStack matrices,
      VertexConsumerProvider vertexConsumers, int light, int overlay) {
    Direction direction = entity.getCachedState().get(Properties.HORIZONTAL_FACING);
    String name = entity.getName();
    renderText(matrices, direction, name, 0.0f, 1.5f, -0.5f, 0.03F, 0xFFffffff);
  }
