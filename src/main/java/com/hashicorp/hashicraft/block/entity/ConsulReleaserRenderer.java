...
public class ConsulReleaserRenderer<T extends ConsulReleaserEntity> implements BlockEntityRenderer<T> {
  ...
  public void render(ConsulReleaserEntity entity, float tickDelta, MatrixStack matrices,
    ...
    renderText(matrices, vertexConsumers, direction, application, 0.0f, 1.5f, 0.0f, 0.015F, 0xFFffffff);
    ...
    renderText(matrices, vertexConsumers, direction, message, 0.0f, 1.3f, 0.0f, 0.03F, color);
  }
  ...
  private void renderText(MatrixStack matrices, VertexConsumerProvider vertexConsumers, Direction direction,
      String message,
    ...
    DrawContext context = new DrawContext(client, (Immediate) vertexConsumers);
    ...
    mat.multiply(yRotation);

    int width = (-textRenderer.getWidth((StringVisitable) text) / 2);
    context.drawTextWithShadow(textRenderer, text, width, 0, color);
    mat.pop();
    ...
    switch (direction) {
      ...
      case NORTH:
        ...
        break;
      case SOUTH:
        yRotation = RotationAxis.POSITIVE_Y.rotationDegrees(0.0F);
        break;
      case EAST:
        yRotation = RotationAxis.POSITIVE_Y.rotationDegrees(-90.0F);
        break;
